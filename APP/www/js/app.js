...
app.config(function ($stateProvider, $urlRouterProvider) {
	...
	.state('app.cadastrar-sintomas', {
		cache: false,
	    url: '/cadastrar-sintomas',
	    views: {
	      'menuContent': {
	        templateUrl: 'templates/cadastrar-sintomas.html',
	        controller: 'CadastroSintomasCtrl'
	      }
	    }
	})

	.state('app.meus-sintomas', {
		cache: false,
	    url: '/meus-sintomas',
	    views: {
	      'menuContent': {
	        templateUrl: 'templates/meus-sintomas.html',
	        controller: 'MeusSintomasCtrl'
	      }
	    }
	})


	.state('app.gerenciar-sintomas', {
		cache: false,
	    url: '/gerenciar-sintomas',
	    views: {
	      'menuContent': {
	        templateUrl: 'templates/gerenciar-sintomas.html',
	        controller: 'GerenciarSintomasCtrl'
	      }
	    }
	})


	.state('app.cadastrar-sintomas-confirmacao', {
		cache: false,
		url: '/cadastrar-sintomas-confirmacao.html',
		views: {
			'menuContent': {
				templateUrl: 'templates/cadastrar-sintomas-confirmacao.html',
				controller: 'CadastroSintomasCtrl'
				}	
